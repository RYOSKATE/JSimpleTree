...
public class NodeTest {
  ...
  public void OperateRoot() {
    ...
    Iterable<StringNode> _prevsFromFirst = root.prevsFromFirst();
    ...
    Iterable<StringNode> _nextsFromSelf = root.nextsFromSelf();
    ...
    Iterable<StringNode> _prevsFromFirstAndSelf = root.prevsFromFirstAndSelf();
    ...
    Iterable<StringNode> _prevsFromSelf = root.prevsFromSelf();
    ...
    Iterable<StringNode> _nextsFromLast = root.nextsFromLast();
    ...
    Iterable<StringNode> _prevsFromSelfAndSelf = root.prevsFromSelfAndSelf();
  ...
  public void Create1Node() {
    ...
    Iterable<StringNode> _descendants = node.descendants();
  ...
  public void CreateTreeAndTraverse() {
    ...
    Matcher<String> _is = Matchers.<String>is(_NormalizeNewLine);
    Assert.<String>assertThat(_string, _is);
    Iterable<StringNode> _descendants = a.descendants();
    final Function1<StringNode, String> _function = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    ...
    Assert.<String>assertThat(_join, _is_1);
    Iterable<StringNode> _descendants_1 = e.descendants();
    ...
    Iterable<StringNode> _descendants_2 = d.descendants();
    ...
    Iterable<StringNode> _descendants_3 = b.descendants();
    ...
    Iterable<StringNode> _descendants_4 = c.descendants();
    ...
    Iterable<StringNode> _descendantsAndSelf = a.descendantsAndSelf();
    ...
    Iterable<StringNode> _descendantsAndSelf_1 = e.descendantsAndSelf();
    ...
    Iterable<StringNode> _descendantsAndSelf_2 = d.descendantsAndSelf();
    ...
    Iterable<StringNode> _descendantsAndSelf_3 = b.descendantsAndSelf();
    ...
    Iterable<StringNode> _descendantsAndSelf_4 = c.descendantsAndSelf();
    ...
    Iterable<StringNode> _descendants_5 = a.descendants(2);
    ...
    Iterable<StringNode> _descendants_6 = e.descendants(2);
    ...
    Iterable<StringNode> _descendants_7 = d.descendants(2);
    ...
    Iterable<StringNode> _descendants_8 = b.descendants(2);
    ...
    Iterable<StringNode> _descendants_9 = c.descendants(2);
    ...
    Iterable<StringNode> _descendants_10 = b.descendants(0);
    ...
    Iterable<StringNode> _descendantsAndSelf_5 = a.descendantsAndSelf(2);
    ...
    Iterable<StringNode> _descendantsAndSelf_6 = e.descendantsAndSelf(2);
    ...
    Iterable<StringNode> _descendantsAndSelf_7 = d.descendantsAndSelf(2);
    ...
    Iterable<StringNode> _descendantsAndSelf_8 = b.descendantsAndSelf(2);
    ...
    Iterable<StringNode> _descendantsAndSelf_9 = c.descendantsAndSelf(2);
    ...
    Iterable<StringNode> _descendantsAndSelf_10 = b.descendantsAndSelf(0);
    ...
    Iterable<StringNode> _siblings = a.siblings();
    ...
    Iterable<StringNode> _siblings_1 = k.siblings();
    ...
    Iterable<StringNode> _siblings_2 = h.siblings();
    ...
    Iterable<StringNode> _siblings_3 = j.siblings();
    ...
    Iterable<StringNode> _siblings_4 = i.siblings();
    ...
    Iterable<StringNode> _siblingsAndSelf = a.siblingsAndSelf();
    ...
    Iterable<StringNode> _siblingsAndSelf_1 = k.siblingsAndSelf();
    ...
    Iterable<StringNode> _siblingsAndSelf_2 = h.siblingsAndSelf();
    ...
    Iterable<StringNode> _siblingsAndSelf_3 = j.siblingsAndSelf();
    ...
    Iterable<StringNode> _siblingsAndSelf_4 = i.siblingsAndSelf();
    ...
    Iterable<StringNode> _siblings_5 = a.siblings(1);
    ...
    Iterable<StringNode> _siblings_6 = k.siblings(1);
    ...
    Iterable<StringNode> _siblings_7 = h.siblings(1);
    ...
    Iterable<StringNode> _siblings_8 = j.siblings(1);
    ...
    Iterable<StringNode> _siblings_9 = i.siblings(1);
    ...
    Iterable<StringNode> _siblings_10 = i.siblings(0);
    ...
    Iterable<StringNode> _siblingsAndSelf_5 = a.siblingsAndSelf(1);
    ...
    Iterable<StringNode> _siblingsAndSelf_6 = k.siblingsAndSelf(1);
    ...
    Iterable<StringNode> _siblingsAndSelf_7 = h.siblingsAndSelf(1);
    ...
    Iterable<StringNode> _siblingsAndSelf_8 = j.siblingsAndSelf(1);
    ...
    Iterable<StringNode> _siblingsAndSelf_9 = i.siblingsAndSelf(1);
    ...
    Iterable<StringNode> _siblingsAndSelf_10 = i.siblingsAndSelf(0);
    ...
    Iterable<StringNode> _ancestors = i.ancestors();
    ...
    Iterable<StringNode> _ancestors_1 = i.ancestors(3);
    ...
    Iterable<StringNode> _ancestors_2 = i.ancestors(2);
    ...
    Iterable<StringNode> _ancestors_3 = i.ancestors(1);
    ...
    Iterable<StringNode> _ancestors_4 = i.ancestors(0);
    ...
    Iterable<StringNode> _ancestorsAndSelf = i.ancestorsAndSelf();
    ...
    Iterable<StringNode> _ancestorsAndSelf_1 = i.ancestorsAndSelf(3);
    ...
    Iterable<StringNode> _ancestorsAndSelf_2 = i.ancestorsAndSelf(2);
    ...
    Iterable<StringNode> _ancestorsAndSelf_3 = i.ancestorsAndSelf(1);
    ...
    Iterable<StringNode> _ancestorsAndSelf_4 = i.ancestorsAndSelf(0);
    ...
    Iterable<StringNode> _ancestorsAndSiblingsAfterSelf = f.ancestorsAndSiblingsAfterSelf();
    ...
    Iterable<StringNode> _ancestorsAndSiblingsAfterSelfAndSelf = f.ancestorsAndSiblingsAfterSelfAndSelf();
    ...
    Iterable<StringNode> _ancestorsAndSiblingsBeforeSelf = f.ancestorsAndSiblingsBeforeSelf();
    ...
    Iterable<StringNode> _ancestorsAndSiblingsBeforeSelfAndSelf = f.ancestorsAndSiblingsBeforeSelfAndSelf();
    ...
    Iterable<StringNode> _ancestorsAndSiblingsAfterSelf_1 = h.ancestorsAndSiblingsAfterSelf();
    ...
    Iterable<StringNode> _ancestorsAndSiblingsAfterSelfAndSelf_1 = h.ancestorsAndSiblingsAfterSelfAndSelf();
    ...
    Iterable<StringNode> _ancestorsAndSiblingsBeforeSelf_1 = h.ancestorsAndSiblingsBeforeSelf();
    ...
    Iterable<StringNode> _ancestorsAndSiblingsBeforeSelfAndSelf_1 = h.ancestorsAndSiblingsBeforeSelfAndSelf();
    ...
    Iterable<StringNode> _ancestors_5 = b.ancestors();
    ...
    Iterable<StringNode> _ancestorsAndSelf_5 = b.ancestorsAndSelf();
    ...
    Iterable<StringNode> _children = b.children();
    ...
    int _childrenCount = b.childrenCount();
    ...
    Iterable<StringNode> _nextsFromSelf = b.nextsFromSelf();
    ...
    Iterable<StringNode> _nextsFromLast = b.nextsFromLast();
    List<StringNode> _list_10 = IterableExtensions.<StringNode>toList(_nextsFromLast);
    ...
    Iterable<StringNode> _prevsFromFirst = b.prevsFromFirst();
    ...
    Iterable<StringNode> _prevsFromFirstAndSelf = b.prevsFromFirstAndSelf();
    ...
    Iterable<StringNode> _prevsFromSelf = b.prevsFromSelf();
    ...
    Iterable<StringNode> _prevsFromSelfAndSelf = b.prevsFromSelfAndSelf();
    ...
    Iterable<StringNode> _descendantsOfFirstChild = b.descendantsOfFirstChild();
    ...
    Iterable<StringNode> _descendantsOfFirstChildAndSelf = b.descendantsOfFirstChildAndSelf();
    ...
    Iterable<StringNode> _ancestors_6 = e.ancestors();
    ...
    Iterable<StringNode> _ancestorsAndSelf_6 = e.ancestorsAndSelf();
    ...
    Iterable<StringNode> _children_1 = e.children();
    ...
    int _childrenCount_1 = e.childrenCount();
    ...
    Iterable<StringNode> _nextsFromSelf_1 = e.nextsFromSelf();
    ...
    Iterable<StringNode> _nextsFromLast_1 = e.nextsFromLast();
    ...
    Iterable<StringNode> _prevsFromFirst_1 = e.prevsFromFirst();
    ...
    Iterable<StringNode> _prevsFromFirstAndSelf_1 = e.prevsFromFirstAndSelf();
    ...
    Iterable<StringNode> _prevsFromSelf_1 = e.prevsFromSelf();
    ...
    Iterable<StringNode> _prevsFromSelfAndSelf_1 = e.prevsFromSelfAndSelf();
    ...
    Iterable<StringNode> _descendantsOfFirstChild_1 = e.descendantsOfFirstChild();
    ...
    Iterable<StringNode> _descendantsOfFirstChildAndSelf_1 = e.descendantsOfFirstChildAndSelf();
    ...
    final Function0<StringNode> restoreG = g.remove();
    Matcher<Object> _nullValue = Matchers.nullValue();
    Matcher<Object> _not = Matchers.<Object>not(_nullValue);
    Matcher<Object> _is_91 = Matchers.<Object>is(_not);
    Assert.<Function0<StringNode>>assertThat(restoreG, _is_91);
    Iterable<StringNode> _descendants_11 = a.descendants();
    ...
    final Function0<StringNode> restoreF = f.remove();
    Matcher<Object> _nullValue_1 = Matchers.nullValue();
    Matcher<Object> _not_1 = Matchers.<Object>not(_nullValue_1);
    Matcher<Object> _is_93 = Matchers.<Object>is(_not_1);
    Assert.<Function0<StringNode>>assertThat(restoreF, _is_93);
    Iterable<StringNode> _descendants_12 = a.descendants();
    ...
    Function0<StringNode> _remove = g.remove();
    Matcher<Object> _nullValue_2 = Matchers.nullValue();
    Matcher<Object> _is_95 = Matchers.<Object>is(_nullValue_2);
    Assert.<Function0<StringNode>>assertThat(_remove, _is_95);
    Function0<StringNode> _remove_1 = f.remove();
    Matcher<Object> _nullValue_3 = Matchers.nullValue();
    Matcher<Object> _is_96 = Matchers.<Object>is(_nullValue_3);
    Assert.<Function0<StringNode>>assertThat(_remove_1, _is_96);
    restoreF.apply();
    Iterable<StringNode> _descendants_13 = a.descendants();
    final Function1<StringNode, String> _function_64 = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    };
    Iterable<String> _map_64 = IterableExtensions.<StringNode, String>map(_descendants_13, _function_64);
    String _join_64 = IterableExtensions.join(_map_64);
    Matcher<String> _is_97 = Matchers.<String>is("edbflimc");
    Assert.<String>assertThat(_join_64, _is_97);
    restoreG.apply();
    Iterable<StringNode> _descendants_14 = a.descendants();
    final Function1<StringNode, String> _function_65 = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    };
    Iterable<String> _map_65 = IterableExtensions.<StringNode, String>map(_descendants_14, _function_65);
    String _join_65 = IterableExtensions.join(_map_65);
    Matcher<String> _is_98 = Matchers.<String>is("edbgkhjflimc");
    Assert.<String>assertThat(_join_65, _is_98);
    Function0<StringNode> _remove_2 = a.remove();
    Matcher<Object> _nullValue_4 = Matchers.nullValue();
    Matcher<Object> _is_99 = Matchers.<Object>is(_nullValue_4);
    Assert.<Function0<StringNode>>assertThat(_remove_2, _is_99);
    Iterable<StringNode> _descendants_15 = a.descendants();
    List<StringNode> _list_52 = IterableExtensions.<StringNode>toList(_descendants_15);
    for (final StringNode node : _list_52) {
      {
        Function0<StringNode> restore = node.remove();
        Matcher<Object> _nullValue_5 = Matchers.nullValue();
        Matcher<Object> _not_2 = Matchers.<Object>not(_nullValue_5);
        Matcher<Object> _is_100 = Matchers.<Object>is(_not_2);
        Assert.<Function0<StringNode>>assertThat(restore, _is_100);
        Iterable<StringNode> _descendants_16 = a.descendants();
        final Function1<StringNode, String> _function_66 = new Function1<StringNode, String>() {
          public String apply(final StringNode it) {
            return it.getValue();
          }
        };
        Iterable<String> _map_66 = IterableExtensions.<StringNode, String>map(_descendants_16, _function_66);
        String _join_66 = IterableExtensions.join(_map_66);
        String _value = node.getValue();
        Matcher<String> _containsString = Matchers.containsString(_value);
        Matcher<String> _not_3 = Matchers.<String>not(_containsString);
        Matcher<String> _is_101 = Matchers.<String>is(_not_3);
        Assert.<String>assertThat(_join_66, _is_101);
        restore.apply();
        Iterable<StringNode> _descendants_17 = a.descendants();
        final Function1<StringNode, String> _function_67 = new Function1<StringNode, String>() {
          public String apply(final StringNode it) {
            return it.getValue();
          }
        };
        Iterable<String> _map_67 = IterableExtensions.<StringNode, String>map(_descendants_17, _function_67);
        String _join_67 = IterableExtensions.join(_map_67);
        Matcher<String> _is_102 = Matchers.<String>is("edbgkhjflimc");
        Assert.<String>assertThat(_join_67, _is_102);
      }
    }
  }
  ...
  public void TraverseSingles() {
    ...
    d.addFirst(e);
    d.addLast(f);
    Iterable<StringNode> _descendantsOfSingle = b.descendantsOfSingle();
    final Function1<StringNode, String> _function = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    ...
    Iterable<StringNode> _descendantsOfSingleAndSelf = b.descendantsOfSingleAndSelf();
    final Function1<StringNode, String> _function_1 = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    ...
    Iterable<StringNode> _descendantsOfSingle_1 = c.descendantsOfSingle();
    final Function1<StringNode, String> _function_2 = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    ...
    Iterable<StringNode> _descendantsOfSingleAndSelf_1 = c.descendantsOfSingleAndSelf();
    final Function1<StringNode, String> _function_3 = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    ...
    Iterable<StringNode> _ancestorsWithSingleChild = b.ancestorsWithSingleChild();
    final Function1<StringNode, String> _function_4 = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    ...
    Iterable<StringNode> _ancestorsWithSingleChildAndSelf = b.ancestorsWithSingleChildAndSelf();
    final Function1<StringNode, String> _function_5 = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    ...
    Iterable<StringNode> _ancestorsWithSingleChild_1 = c.ancestorsWithSingleChild();
    final Function1<StringNode, String> _function_6 = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    ...
    Iterable<StringNode> _ancestorsWithSingleChildAndSelf_1 = c.ancestorsWithSingleChildAndSelf();
    final Function1<StringNode, String> _function_7 = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    ...
    Iterable<StringNode> _ancestorsWithSingleChild_2 = d.ancestorsWithSingleChild();
    final Function1<StringNode, String> _function_8 = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    ...
    Iterable<StringNode> _ancestorsWithSingleChildAndSelf_2 = d.ancestorsWithSingleChildAndSelf();
    final Function1<StringNode, String> _function_9 = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    ...
    Iterable<StringNode> _ancestorsWithSingleChild_3 = e.ancestorsWithSingleChild();
    final Function1<StringNode, String> _function_10 = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
    ...
    Iterable<StringNode> _ancestorsWithSingleChildAndSelf_3 = e.ancestorsWithSingleChildAndSelf();
    final Function1<StringNode, String> _function_11 = new Function1<StringNode, String>() {
      public String apply(final StringNode it) {
        return it.getValue();
      }
